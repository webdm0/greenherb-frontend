...
function DropdownMenu({
  modal = false,
  ...props
}: React.ComponentProps<typeof DropdownMenuPrimitive.Root> & { modal?: boolean }) {
  return (
...
function DropdownMenuTrigger({
  ...
  return (
    <DropdownMenuPrimitive.Trigger
      ...
      className={cn(
        'cursor-pointer [&_[data-dropdown-chevron]]:transition-transform [&_[data-dropdown-chevron]]:duration-200 data-[state=open]:[&_[data-dropdown-chevron]]:rotate-180',
        className,
      )}
      {...props}
    />
...
function DropdownMenuSubTrigger({
  ...
  return (
    ...
    >
      {children}
      <IconChevronRight className="ml-auto size-4" stroke={1.75} />
    </DropdownMenuPrimitive.SubTrigger>
  )
}
